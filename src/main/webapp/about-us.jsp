...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | About Us</title><!-- Stylesheets -->
                            ...
                            <nav class="nav main-menu">
                                <ul class="navigation" id="navbar">
                                    ...
                                    <li class="current dropdown"><span>Pages</span>
                                        <ul>
                                            <li class="current"><a href="about-us.jsp">About Us</a></li>
                        ...
                        <div class="inner-column">
                            <div class="appointment-form default-form">
                                ...
                                <form action="#" method="post" id="email-form">
                                    ...
                                    <div class="form-group"><button class="theme-btn btn-style-one" type="button"
                                            name="submit-form"><span class="btn-title">Submit Query</span></button>
                                    </div>
                                </form>
                            </div>
                        </div>
