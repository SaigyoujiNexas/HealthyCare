...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Blog Four Column</title><!-- Stylesheets -->
                                ...
                                <ul class="navigation" id="navbar">
                                    ...
                                    <li class="current dropdown"><span>Blog</span>
                                        <ul>
                                            ...
                                            <li class="current"><a href="blog-four-col-wide.jsp">Four Colums</a></li>
                    ...
                    <div class="news-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="text">Nullam mauris vitae tortor sodales efficitur. Quisque orci ante.</div>
                                <div class="post-info">
