                        ...
                        <div class="nav-outer">
                            <nav class="nav main-menu">
                                <ul class="navigation" id="navbar">
                                    ...
                                    <li class="dropdown current"><span>Blog</span>
                                        <ul>
                                            <li><a href="blog-checkboard.jsp">Checkerboard</a></li>
                                            <li class="current"><a href="blog-masonry.jsp">Masonry</a></li>
        ...
        <section class="blog-section blog-masonry">
            <div class="auto-container">
                <div class="masonry-items-container row">
                    <!-- News Block -->
                    <div class="news-block col-lg-4 col-md-6 col-sm-12 masonry-item">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="blog-post-image.jsp"><img
                                        src="images/resource/blog-masonry-1.jpg" alt=""></a></figure><a href="#"
                                                                                                        class="date">Sep 19,2020</a>
                            </div>
                            <div class="lower-content">
                                <h4><a href="blog-post-image.jsp">Diagnostic Services for Efficient Results Picking</a>
                                </h4>
                    ...
                    <div class="news-block col-lg-4 col-md-6 col-sm-12 masonry-item">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="blog-post-image.jsp"><img
                                        src="images/resource/blog-masonry-2.jpg" alt=""></a></figure><a href="#"
                                                                                                        class="date">Sep 19,2020</a>
                            </div>
                            <div class="lower-content">
                                <h4><a href="blog-post-image.jsp">Preparing for an ECG Tips From Our
                                        Diagnosticians.</a></h4>
                                <div class="text">Nullam mauris vitae tortor sodales efficitur. Quisque orci ante. Proin
                                    amet turpis</div>
                                <div class="post-info">
                    ...
                    <div class="news-block col-lg-4 col-md-6 col-sm-12 masonry-item">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="blog-post-image.jsp"><img
                                        src="images/resource/blog-masonry-3.jpg" alt=""></a></figure><a href="#"
                                                                                                        class="date">Sep 19,2020</a>
                            </div>
                            <div class="lower-content">
                                <h4><a href="blog-post-image.jsp">Reasons to Visit for Heart Specialist Department.</a>
                                </h4>
                                <div class="text">Nullam mauris vitae tortor sodales efficitur. Quisque orci ante. Proin
                                    amet turpis</div>
                                <div class="post-info">
                    ...
                    <div class="news-block col-lg-4 col-md-6 col-sm-12 masonry-item">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="blog-post-image.jsp"><img
                                        src="images/resource/blog-masonry-4.jpg" alt=""></a></figure><a href="#"
                                                                                                        class="date">Sep 19,2020</a>
                            </div>
                            <div class="lower-content">
                                <h4><a href="blog-post-image.jsp">Diagnostic Services for Efficient Results Picking</a>
                    ...
                    <div class="news-block col-lg-4 col-md-6 col-sm-12 masonry-item">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="blog-post-image.jsp"><img
                                        src="images/resource/blog-masonry-6.jpg" alt=""></a></figure><a href="#"
                                                                                                        class="date">Sep 19,2020</a>
                            </div>
                            <div class="lower-content">
                                <h4><a href="blog-post-image.jsp">Preparing for an ECG Tips From Our
                    ...
                    <div class="news-block col-lg-4 col-md-6 col-sm-12 masonry-item">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="blog-post-image.jsp"><img
                                        src="images/resource/blog-masonry-5.jpg" alt=""></a></figure><a href="#"
                                                                                                        class="date">Sep 19,2020</a>
                            </div>
                            <div class="lower-content">
                                <h4><a href="blog-post-image.jsp">Diagnostic Services for Efficient Results Picking</a>
