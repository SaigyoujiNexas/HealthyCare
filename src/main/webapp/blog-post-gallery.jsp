...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Blog Post Gallery</title><!-- Stylesheets -->
                        ...
                        <div class="nav-outer">
                            <nav class="nav main-menu">
                                <ul class="navigation" id="navbar">
                                    ...
                                    <li class="current dropdown"><span>Blog</span>
                                        <ul>
                                            ...
                                            <li class="current dropdown"><span class="current">Post Types</span>
                                                <ul>
                                                    <li><a href="blog-post-image.jsp">Image Post</a></li>
                                                    <li class="current"><a href="blog-post-gallery.jsp">Gallery
                                                            Post</a></li>
                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        <div class="blog-post">
                            ...
                            <div class="news-block">
                                <div class="inner-box">
                                    <div class="image">
                                        <div class="single-item-carousel owl-carousel owl-theme default-arrows">
                                            <div class="slide-item"><a href="images/resource/blog-1.jpg"
                                                    class="lightbox-image" data-fancybox="gallery"><img
                                                    src="images/resource/blog-1.jpg" alt=""></a></div>
                                            <div class="slide-item"><a href="images/resource/blog-3.jpg"
                                                    class="lightbox-image" data-fancybox="gallery"><img
                                                    src="images/resource/blog-3.jpg" alt=""></a></div>
                                            <div class="slide-item"><a href="images/resource/blog-4.jpg"
                                                    class="lightbox-image" data-fancybox="gallery"><img
                                                    src="images/resource/blog-4.jpg" alt=""></a></div>
                                        </div>
                                    </div>
                                    <div class="lower-content">
                                        ...
                                        <p>Nullam mauris vitae tortor sodales efficitur. Quisque orci ante. Proin amet
                                            turpis l Nullam mauris vitae tortor sodales efficitur. There have been a lot
                                            of cases in which people were not provided with accurate reports that
                                            eventually affected their medical treatment. Lorem ipsum dolor sit
                                            amet,consectetur adipisicing elit,sed do eiusmod tempor incididunt ut labore
                                            et dolore magna aliqua.</p>
                                        <blockquote>It's a beautiful day in this neighborhood a beautiful day for a
                                            neighbor. Would you be mine could you be mine Its a neighborly day in this
                                            beautywood a neighborly day for a beauty.</blockquote>
                                        <p>There anyone who loves or pursues or desires to obtain pain of itself,because
                                            ...
                                            us ever undertakes laborious <a href="#">here is link.</a></p>
                                        <div class="two-column row">
                                            <div class="image-column col-lg-6 col-md-6 col-sm-12">
                                                <figure class="image wow fadeIn"><img src="images/resource/blog-1.jpg"
                                                        alt=""></figure>
                                            </div>
                                            <div class="content-column col-lg-6 col-md-6 col-sm-12">
                                                <p>know how to pursue pleasure rationally encounter consequences that
                                                    ...
                                                    because occasionally circumstances occur which toil and pain can
                                                    undertakes laborious physical exercise. </p>
                                            </div>
                                        </div>
                                        <p>Over the river and through the woods was more dangerous back when cars had
                                            crummy bias-ply tires,rear-wheel drive. Kevin tail capicola
                                            bresaola,prosciutto swine cupim tri-tip boudin shoulder frankfurter. This
                                            process repeats many times per second until the vehicle stops or you lift
                                            your foot off the brake pedal ordinary brakes. Kevin tail capicola
                                            bresaola,prosciutto swine cupim tri-tip boudin shoulder frank furter</p>
                                    </div>
                                </div>
                            </div><!-- Other Options -->
                        ...
                        <div class="author-box">
                            <div class="inner-box clearfix">
                                <div class="thumb"><img src="images/resource/author-thumb.jpg" alt=""></div><span
                                    class="title">Author</span>
                                <h4 class="name">Dr. Robert Lee</h4>
                                <div class="text">Dynamically innovate resource and leveling customer service for state
                                    of the art customer service circumstances occur.</div>
                                <ul class="social-icon-one">
                                    <li><a href="#"><span class="fab fa-facebook"></span></a></li>
                                    <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                                    <li><a href="#"><span class="fab fa-whatsapp"></span></a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="news-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                                    <div class="inner-box">
                                        ...
                                        <div class="lower-content">
                                            <h4><a href="blog-post-image.jsp">What is The Success rate<br>of a root
                                                    canel?</a></h4>
                                            <div class="text">Nullam mauris vitae tortor sodales efficitur. Quisque orci
                                                ante. Proin amet turpis</div>
                                            <div class="post-info">
                                ...
                                <div class="news-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                                    <div class="inner-box">
                                        ...
                                        <div class="lower-content">
                                            <h4><a href="blog-post-image.jsp">How to handle your kids’ <Br>mystery
                                                    ailments?</a></h4>
                                            <div class="text">Nullam mauris vitae tortor sodales efficitur. Quisque orci
                                                ante. Proin amet turpis</div>
                                            <div class="post-info">
                        ...
                        <div class="comments-area">
                            ...
                            <div class="comment-box">
                                <div class="comment">
                                    ...
                                    <div class="text">Lorem ipsum dolor sit amet,consectetur adipiscing elit. Duis
                                        aliquet tempor tempor. Pellentesque facilisis,ligula ut porta lobortis,enim.
                                    </div><a href="#" class="reply-btn">Reply</a>
                                </div>
                            </div>
                            ...
                            <div class="comment-box">
                                <div class="comment">
                                    ...
                                    <div class="text">Lorem ipsum dolor sit amet,consectetur adipiscing elit. Duis
                                        aliquet tempor tempor. Pellentesque facilisis,ligula ut porta lobortis,enim
                                        magna convallis est.</div><a href="#" class="reply-btn">Reply</a>
                                </div>
                            </div>
                        </div>
                        <!--Comment Form-->
                        <div class="comment-form">
                            ...
                            <form method="post" action="blog.html">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group"><textarea name="message"
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group"><button
                                            class="theme-btn btn-style-one" type="submit" name="submit-form"><span
                                                class="btn-title">Post Comment</span></button></div>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
                        <aside class="sidebar">
                            ...
                            <div class="sidebar-widget search-box">
                                <form method="post" action="blog.html">
                                    <div class="form-group"><input type="search" name="search-field" value=""
                                            placeholder="Search....." required=""><button type="submit"><span
                                                class="icon fa fa-search"></span></button></div>
                                </form>
                            </div><!-- Categories -->
                            ...
                            <div class="sidebar-widget latest-news">
                                ...
                                <div class="widget-content">
                                    <article class="post">
                                        ...
                                        <h5><a href="blog-single.html">How to handle your kids’<br>from mystery
                                                ailments</a></h5>
                                    ...
                                    <article class="post">
                                        ...
                                        <h5><a href="blog-single.html">Lung cancer survival rate <br>in England
                                                improves</a></h5>
                                    ...
                                    <article class="post">
                                        ...
                                        <h5><a href="blog-single.html">Negative statin stories add <br>to heart health
                                                risk</a></h5>
                            ...
                            <div class="sidebar-widget newslatters">
                                ...
                                <form method="post" action="blog-sidebar.html">
                                    <div class="form-group"><input type="text" name="input" value=""
                                            placeholder="Your email address..." required=""><button type="submit"
                                            class="theme-btn"><span class="btn-title">Subscribe</span></button></div>
                                </form>
