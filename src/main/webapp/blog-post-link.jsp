...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Blog Post Link</title><!-- Stylesheets -->
                                        ...
                                        <ul>
                                            ...
                                            <li class="current dropdown"><span>Post Types</span>
                                                <ul>
                                                    ...
                                                    <li class="current"><a href="blog-post-link.jsp">Link Post</a></li>
                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        <div class="blog-post">
                            ...
                            <div class="news-block">
                                <div class="inner-box">
                                    <div class="image">
                                        <div class="post-format-link"><span class="icon fa fa-link"></span><a
                                                href="#">sed quia non numquam eius modi tempora incidunt ut labore et
                                                dolore.</a></div>
                                    </div>
