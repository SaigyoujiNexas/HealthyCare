...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Blog Post Quote</title><!-- Stylesheets -->
                                        ...
                                        <ul>
                                            ...
                                            <li class="current dropdown"><span>Post Types</span>
                                                <ul>
                                                    ...
                                                    <li class="current"><a href="blog-post-quote.jsp">Quote Post</a>
                                                    </li>
                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        <div class="blog-post">
                            ...
                            <div class="news-block">
                                <div class="inner-box">
                                    <div class="image">
                                        <blockquote class="post-format-quote"><span
                                                class="icon fa fa-quote-left"></span>Over the river and through the
                                            woods was more dangerous back when cars had crummy bias-ply tires,rear-wheel
                                            drive. Kevin tail capicola bresaola,prosciutto swine cupim tri-tip boudin
                                            shoulder frankfurter. <cite>Tommy Willson</cite></blockquote>
                                    </div>
