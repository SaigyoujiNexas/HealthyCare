...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Blog Post Video</title><!-- Stylesheets -->
                                        ...
                                        <ul>
                                            ...
                                            <li class="current dropdown"><span>Post Types</span>
                                                <ul>
                                                    ...
                                                    <li class="current"><a href="blog-post-video.jsp">Video Post</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                    ...
                    <div class="content-side col-lg-8 col-md-12 col-sm-12">
                        <div class="blog-post">
                            ...
                            <div class="news-block">
                                <div class="inner-box">
                                    <div class="image">
                                        <div class="media-player"><iframe
                                                src="https://www.youtube.com/embed/wQ2TN_gI3sE?feature=oembed"></iframe>
                                        </div>
                                    </div>
