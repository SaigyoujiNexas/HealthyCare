...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Blog Two Column</title><!-- Stylesheets -->
                                ...
                                <ul class="navigation" id="navbar">
                                    ...
                                    <li class="current dropdown"><span>Blog</span>
                                        <ul>
                                            ...
                                            <li class="current"><a href="blog-two-col.jsp">Two Columns</a></li>
                ...
                <div class="row">
                    ...
                    <div class="news-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <h4><a href="blog-post-image.jsp">Diagnostic Services for Efficient Results
                                        Picking?</a></h4>
                                <div class="text">There have been a lot of cases in which people were not provided with
                                    accurate reports that eventually affected their medical treatment.</div>
                                <div class="post-info">
                    ...
                    <div class="news-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <h4><a href="blog-post-image.jsp">Preparing for an ECG Tips From Diagnosticians .</a>
                                </h4>
                                <div class="text">There have been a lot of cases in which people were not provided with
                                    accurate reports that eventually affected their medical treatment.</div>
                                <div class="post-info">
                    ...
                    <div class="news-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <h4><a href="blog-post-image.jsp">How to handle your kids’ mystery ailments?</a></h4>
                                <div class="text">There have been a lot of cases in which people were not provided with
                                    accurate reports that eventually affected their medical treatment.</div>
                                <div class="post-info">
                                    <div class="post-author">By Admin Rose</div>
                    ...
                    <div class="news-block col-lg-6 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <h4><a href="blog-post-image.jsp">How to help the cardiology department</a></h4>
                                <div class="text">There have been a lot of cases in which people were not provided with
                                    accurate reports that eventually affected their medical treatment.</div>
                                <div class="post-info">
                                    <div class="post-author">By Admin Rose</div>
