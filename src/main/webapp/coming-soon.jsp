...
<head>
    <meta charset="utf-8">
    <title>Meto HTML-5 Template | Comming Soon</title><!-- Stylesheets -->
...
<body class="hidden-bar-wrapper">
    <div class="page-wrapper">
        <!-- Preloader -->
        <div class="preloader"></div><!-- Coming Soon -->
                                ...
                                <div class="emailed-form">
                                    ...
                                    <form method="post" action="index.jsp">
                                        <div class="form-group"><input type="email" name="email" value=""
                                                placeholder="Your Email" required><button type="submit"><span
                                                    class="fa fa-paper-plane"></span></button></div>
                                    </form>
                                </div>
