...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Dedicated Doctors</title><!-- Stylesheets -->
                        ...
                        <div class="nav-outer">
                            <nav class="nav main-menu">
                                <ul class="navigation" id="navbar">
                                    ...
                                    <li class="dropdown current"><span>Doctors</span>
                                        <ul>
                                            <li class="current"><a href="doctors.jsp">Doctors</a></li>
            ...
            <div class="auto-container">
                <div class="row">
                    ...
                    <div class="team-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="doctor-detail.jsp"><img src="images/resource/team-8.jpg"
                                                                                       alt=""></a></figure>
                                <ul class="social-links">
                                    <li><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                    <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                    ...
                    <div class="team-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="doctor-detail.jsp"><img src="images/resource/team-9.jpg"
                                                                                       alt=""></a></figure>
                                <ul class="social-links">
                                    <li><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                    <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                    ...
                    <div class="team-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="doctor-detail.jsp"><img
                                        src="images/resource/team-10.jpg" alt=""></a></figure>
                                <ul class="social-links">
                                    <li><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                    <li><a href="#"><span class="fab fa-twitter"></span></a></li>
                                    <li><a href="#"><span class="fab fa-instagram"></span></a></li>
