...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | UI Elements</title><!-- Stylesheets -->
    ...
    <div class="page-wrapper">
                        ...
                        <div class="nav-outer">
                            <nav class="nav main-menu">
                                <ul class="navigation" id="navbar">
                                    <li class="dropdown"><span>Home</span>
                                        <ul>
                                    ...
                                    <li class="current dropdown"><span>Pages</span>
                                        <ul>
                                            <li><a href="about-us.jsp">About Us</a></li>
                                            <li><a href="services.jsp">Services</a></li>
                                            <li><a href="gallery.jsp">Gallery</a></li>
                                            <li><a href="pricing-table.jsp">Pricing Table</a></li>
                                            <li class="current"><a href="elements.jsp">UI Elements</a></li>
        ...
        <section class="content-elements bg_alice">
            <div class="auto-container">
                <!-- typography -->
                <div class="sec-title">
                    <h2>Typography</h2><span class="divider"></span>
                </div>
                <div class="row">
                ...
                <hr class="divider-one"><!-- End typography -->
                <!-- Info Boxes -->
                <div class="sec-title">
                    <h2>Info Boxes</h2><span class="divider"></span>
                </div>
                <div class="row mb-5">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="message-box with-icon info">
                            <div class="icon-box"><span class="icon fa fa-info"></span></div>
                            <p>Far far away,behind the word mountains</p><a href="#" class="close-btn"><span
                                    class="icon fa fa-times"></span></a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12">
                ...
                <hr class="divider-one"><!-- End Info Boxes -->
                <!-- Accordion -->
                <div class="sec-title">
                    <h2>Accordions</h2><span class="divider"></span>
                </div>
                <div class="row mb-5">
                    <div class="column col-lg-6 col-md-12 col-sm-12">
                        ...
                        <ul class="accordion-box">
                            ...
                            <li class="accordion block">
                                <div class="acc-btn">I can’t remember my user id and/or password,can you reset it? <span
                                        class="icon fa fa-chevron-down"></span></div>
                                <div class="acc-content">
                                    <div class="content">
                                        <p>Track your results on the local or global market,depending on your needs. You
                                            can track everything in the most popular search engines - and increase
                            ...
                            <li class="accordion block active-block">
                                <div class="acc-btn active">How can I find out who is the hiring manager or lead
                                    recruiter. <span class="icon fa fa-chevron-down"></span></div>
                            ...
                            <!--Block-->
                            <li class="accordion block">
                                <div class="acc-btn">Nam I have several accounts,can they be purged or deleted? <span
                                        class="icon fa fa-chevron-down"></span></div>
                                <div class="acc-content">
                                    <div class="content">
                                        <p>Track your results on the local or global market,depending on your needs. You
                ...
                <!-- Tabs -->
                <div class="sec-title">
                    <h2>Tabs</h2><span class="divider"></span>
                </div>
                <div class="row mb-5">
                    <div class="column col-lg-6 col-md-12 col-sm-12">
                        <div class="default-tabs tabs-box">
                            ...
                            <ul class="tab-buttons clearfix">
                                <li class="tab-btn" data-tab="#tab1">Item 1</li>
                                <li class="tab-btn active-btn" data-tab="#tab2">Item 2</li>
                                <li class="tab-btn" data-tab="#tab3">Item 3</li>
                            </ul>
                            <div class="tabs-content">
                                <!--Tab-->
                                <div class="tab" id="tab1">
                                    <p>Sed bibendum quis orci sit amet fringilla. Suspendisse nec massa at sem
                                        condimentum rutrum id cursus odio. Phasellus sollicitudin ante vitae erat
                                        posuere faucibus. Pellentesque nec tristique purus. In dapibus fermentum nibh,ut
                                        imperdiet magna volutpat in. Vestibulum semper eleifend augue ac consectetur.
                                        Pellentesque tempus sit amet massa et rutrum.</p>
                                </div>
                                <!--Tab-->
                    ...
                    <div class="column col-lg-6 col-md-12 col-sm-12">
                        <div class="default-tabs style-two tabs-box">
                            <!--Tabs Box-->
                            <ul class="tab-buttons clearfix">
                                <li class="tab-btn" data-tab="#tab4">Item 1</li>
                                <li class="tab-btn active-btn" data-tab="#tab5">Item 2</li>
                            ...
                            <div class="tabs-content">
                                ...
                                <!--Tab-->
                                <div class="tab active-tab" id="tab5">
                                    <p>Sed bibendum quis orci sit amet fringilla. Suspendisse nec massa at sem
                                        condimentum rutrum id cursus odio. Phasellus sollicitudin ante vitae erat
                                        posuere faucibus. Pellentesque nec tristique purus. In dapibus fermentum nibh,ut
                                        imperdiet magna volutpat in. Vestibulum semper eleifend augue ac consectetur.
                ...
                <!--Table -->
                <div class="sec-title">
                    <h2>Table</h2><span class="divider"></span>
                </div>
                <div class="row mb-5">
                    <div class="col-lg-12">
                ...
                <!-- Buttons -->
                <div class="sec-title">
                    <h2>Buttons</h2><span class="divider"></span>
                </div>
                <div class="row mb-5">
                    <div class="col-lg-12">
                        <div class="row buttons">
                            <div class="btn-column column col-lg-3 col-md-6 col-sm-12"><a href="#"
                                    class="theme-btn btn-style-one large"><span class="btn-title">Button</span></a><a
                                    href="#" class="theme-btn btn-style-one"><span class="btn-title">Button</span></a><a
                                    href="#" class="theme-btn btn-style-one small"><span
                                        class="btn-title">Button</span></a></div>
                            <div class="btn-column column col-lg-3 col-md-6 col-sm-12"><a href="#"
                                    class="theme-btn btn-style-two large"><span class="btn-title">Button</span></a><a
                                    href="#" class="theme-btn btn-style-two"><span class="btn-title">Button</span></a><a
                                    href="#" class="theme-btn btn-style-two small"><span
                                        class="btn-title">Button</span></a></div>
                            <div class="btn-column column col-lg-3 col-md-6 col-sm-12"><a href="#"
                                    class="theme-btn btn-style-three large"><span class="btn-title">Button</span></a><a
                                    href="#" class="theme-btn btn-style-three"><span
                                        class="btn-title">Button</span></a><a href="#"
                                    class="theme-btn btn-style-three small"><span class="btn-title">Button</span></a>
                            </div>
                            <div class="btn-column column col-lg-3 col-md-6 col-sm-12"><a href="#"
                                    class="theme-btn btn-style-four large"><span class="btn-title">Button</span></a><a
                                    href="#" class="theme-btn btn-style-four"><span
                                        class="btn-title">Button</span></a><a href="#"
                                    class="theme-btn btn-style-four small"><span class="btn-title">Button</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <hr class="divider-one"><!-- End Buttons -->
                <!-- Progress Bars -->
                <div class="sec-title">
                    <h2>Progress Bars</h2><span class="divider"></span>
                </div>
                <div class="row mb-5">
                    <div class="col-lg-12">
                        <!--Skills-->
                ...
                <!-- Gallery -->
                <div class="sec-title">
                    <h2>Gallery</h2><span class="divider"></span>
                </div>
                <div class="row mb-5">
                    <!-- Portfolio Block -->
                    <div class="portfolio-block all mix detal-care dental col-lg-4 col-md-6 col-sm-12">
                        <div class="image-box">
                            ...
                            <div class="overlay"><a href="images/gallery/1-1.jpg" class="icon-box lightbox-image"><span
                ...
                <hr class="divider-one"><!-- End Gallery -->
                <!-- Pricing Plan -->
                <div class="sec-title">
                ...
                <!-- Testimonial -->
                <div class="sec-title">
                    <h2>Testimonials</h2><span class="divider"></span>
                </div>
                    ...
                    <div class="testimonial-outer">
                        ...
                        <div class="client-thumb-outer">
                            <div class="client-thumbs-carousel owl-carousel owl-theme">
                                <div class="thumb-item">
                                    <figure class="thumb-box"><img src="images/resource/testi-thumb-1.jpg" alt="">
                                    </figure>
                                ...
                                <div class="thumb-item">
                                    <figure class="thumb-box"><img src="images/resource/testi-thumb-2.jpg" alt="">
                                    </figure>
                                    <div class="author-info"><span class="icon fa fa-quote-left"></span>
                                        <div class="author-name">Lara Croft</div>
                                        <div class="designation">Restaurant Owner</div>
                                ...
                                <div class="thumb-item">
                                    <figure class="thumb-box"><img src="images/resource/testi-thumb-3.jpg" alt="">
                                    </figure>
                                    <div class="author-info"><span class="icon fa fa-quote-left"></span>
                                        <div class="author-name">Lara Croft</div>
                                        <div class="designation">Restaurant Owner</div>
                        ...
                        <div class="client-testimonial-carousel default-dots owl-carousel owl-theme">
                            ...
                            <div class="testimonial-block">
                                <div class="inner-box">
                                    <div class="text">Medical Centre is a great place to get all of your medical needs.
                                        I came in for a check up and did not wait more than 5 minutes before I was seen.
