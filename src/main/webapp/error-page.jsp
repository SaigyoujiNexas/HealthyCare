...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Error Page</title><!-- Stylesheets -->
                                ...
                                <ul class="navigation" id="navbar">
                                    ...
                                    <li class="current dropdown"><span>Pages</span>
                                        <ul>
                                            ...
                                            <li class="current"><a href="error-page.jsp">Error 404</a></li>
        ...
        <section class="error-section">
            <div class="auto-container">
                <div class="content-box">
                    <figure class="error-image"><img src="images/icons/error.png" alt=""></figure>
                    <h2>Page not found</h2>
                    <div class="text">Please try one of the following pages:</div><a href="index.jsp"
                        class="theme-btn btn-style-one"><span class="btn-title">Home Page</span></a><a
                        href="contact.jsp" class="theme-btn btn-style-one"><span class="btn-title">Contact
                            Us</span></a>
                </div>
            </div>
        </section>
