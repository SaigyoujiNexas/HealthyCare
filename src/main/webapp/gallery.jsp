...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Gallery</title><!-- Stylesheets -->
    ...
    <div class="page-wrapper">
                                ...
                                <ul class="navigation" id="navbar">
                                    ...
                                    <li class="dropdown current"><span>Pages</span>
                                        <ul>
                                            ...
                                            <li class="current"><a href="services.jsp">Gallery</a></li>
        ...
        <section class="portfolio-section alternate">
            <div class="auto-container">
                    ...
                    <div class="filter-list row mid-spacing">
                        ...
                        <div class="portfolio-block all mix detal-care dental col-lg-4 col-md-6 col-sm-12">
                            <div class="image-box">
                                ...
                                <div class="overlay"><a href="images/gallery/1-1.jpg" class="icon-box lightbox-image"
                                                        data-fancybox="gallery"><span class="fa fa-expand"></span></a>
                                    <div class="title-box">
                        ...
                        <div class="portfolio-block all mix cancer cardiology eye-care col-lg-4 col-md-6 col-sm-12">
                            <div class="image-box">
                                ...
                                <div class="overlay"><a href="images/gallery/1-2.jpg" class="icon-box lightbox-image"
                                                        data-fancybox="gallery"><span class="fa fa-expand"></span></a>
                                    <div class="title-box">
                                        <h5>Diagnostic Imagine</h5>
                                        <div class="cat"><a href="#">Orthopedics</a>,<a href="#">Pharmacy</a>,</div>
                        ...
                        <div class="portfolio-block all mix detal-care dental cardiology col-lg-4 col-md-6 col-sm-12">
                            <div class="image-box">
                                ...
                                <div class="overlay"><a href="images/gallery/1-3.jpg" class="icon-box lightbox-image"
                                                        data-fancybox="gallery"><span class="fa fa-expand"></span></a>
                                    <div class="title-box">
                                        <h5>Diagnostic Imagine</h5>
                                        <div class="cat"><a href="#">Orthopedics</a>,<a href="#">Pharmacy</a>,</div>
                        ...
                        <div class="portfolio-block all mix cancer dental eye-care col-lg-4 col-md-6 col-sm-12">
                            <div class="image-box">
                                ...
                                <div class="overlay"><a href="images/gallery/1-4.jpg" class="icon-box lightbox-image"
                                                        data-fancybox="gallery"><span class="fa fa-expand"></span></a>
                                    <div class="title-box">
                                        <h5>Diagnostic Imagine</h5>
                                        <div class="cat"><a href="#">Orthopedics</a>,<a href="#">Pharmacy</a>,</div>
                        ...
                        <div class="portfolio-block all mix detal-care cardiology col-lg-4 col-md-6 col-sm-12">
                            <div class="image-box">
                                ...
                                <div class="overlay"><a href="images/gallery/1-5.jpg" class="icon-box lightbox-image"
                                                        data-fancybox="gallery"><span class="fa fa-expand"></span></a>
                                    <div class="title-box">
                                        <h5>Diagnostic Imagine</h5>
                                        <div class="cat"><a href="#">Orthopedics</a>,<a href="#">Pharmacy</a>,</div>
                        ...
                        <div class="portfolio-block all mix cancer cardiology eye-care col-lg-4 col-md-6 col-sm-12">
                            <div class="image-box">
                                ...
                                <div class="overlay"><a href="images/gallery/1-6.jpg" class="icon-box lightbox-image"
                                                        data-fancybox="gallery"><span class="fa fa-expand"></span></a>
                                    <div class="title-box">
                                        <h5>Diagnostic Imagine</h5>
                                        <div class="cat"><a href="#">Orthopedics</a>,<a href="#">Pharmacy</a>,</div>
                        ...
                        <div class="portfolio-block all mix cancer dental eye-care col-lg-4 col-md-6 col-sm-12">
                            <div class="image-box">
                                ...
                                <div class="overlay"><a href="images/gallery/1-7.jpg" class="icon-box lightbox-image"
                                        data-fancybox="gallery"><span class="fa fa-expand"></span></a>
                                    <div class="title-box">
                                        <h5>Diagnostic Imagine</h5>
                                        <div class="cat"><a href="#">Orthopedics</a>,<a href="#">Pharmacy</a>,</div>
                        ...
                        <div class="portfolio-block all mix detal-care cardiology col-lg-4 col-md-6 col-sm-12">
                            <div class="image-box">
                                ...
                                <div class="overlay"><a href="images/gallery/1-8.jpg" class="icon-box lightbox-image"
                                        data-fancybox="gallery"><span class="fa fa-expand"></span></a>
                                    <div class="title-box">
                                        <h5>Diagnostic Imagine</h5>
                                        <div class="cat"><a href="#">Orthopedics</a>,<a href="#">Pharmacy</a>,</div>
                        ...
                        <div class="portfolio-block all mix cancer cardiology eye-care col-lg-4 col-md-6 col-sm-12">
                            <div class="image-box">
                                ...
                                <div class="overlay"><a href="images/gallery/1-9.jpg" class="icon-box lightbox-image"
                                        data-fancybox="gallery"><span class="fa fa-expand"></span></a>
                                    <div class="title-box">
                                        <h5>Diagnostic Imagine</h5>
                                        <div class="cat"><a href="#">Orthopedics</a>,<a href="#">Pharmacy</a>,</div>
                ...
                <div class="btn-box"><a href="#" class="theme-btn btn-style-three load-more"><span
                            class="btn-title">Load More</span></a></div>
            </div>
