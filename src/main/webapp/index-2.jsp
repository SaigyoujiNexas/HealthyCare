...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Home Clanic</title><!-- Stylesheets -->
...
<body>
    <div class="page-wrapper color-scheme-tealblue">
        <!-- Preloader -->
        ...
        <header class="main-header header-style-two">
                ...
                <div class="auto-container">
                    <div class="inner-container">
                        ...
                        <div class="top-right">
                            ...
                            <div class="btn-box"><a href="appointment.jsp" id="appointment-btn"
                                                    class="theme-btn btn-style-three"><span class="btn-title">Appointment</span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="header-lower">
                <div class="auto-container">
                    ...
                    <div class="main-box">
                        <div class="logo-box">
                            <div class="logo"><a href="index.jsp"><img src="images/logo-3.png" alt="" title=""></a>
                            </div>
                        </div>
                        <!--Nav Box-->
                        <div class="nav-outer">
                                ...
                                <ul class="navigation" id="navbar">
                                    <li class="current dropdown"><span>Home</span>
                                        <ul>
                                            ...
                                            <li class="current"><a href="index-2.jsp">Home Clanic</a></li>
                            ...
                            <div class="outer-box">
                                <!-- Shoppping Car --><button class="cart-btn"><i
            ...
            <div class="sticky-header">
                <div class="auto-container">
                    <div class="main-box">
                        <div class="logo-box">
                            <div class="logo"><a href="index.jsp"><img src="images/logo-4.png" alt="" title=""></a>
                            </div>
                        </div>
            ...
            <div class="mobile-header">
                <div class="logo"><a href="index.jsp"><img src="images/logo-4.png" alt="" title=""></a></div>
                <!--Nav Box-->
                ...
                <div class="slide-item" style="background-image: url(images/main-slider/2-1.jpg);">
                    <div class="auto-container">
                        <div class="content-outer">
                            <div class="content-box"><span class="title">Welcome Our Hospital</span>
                                <h2>We Are Provide Total <span>Healthcare</span>Solutions</h2>
                                <div class="text">behind the word mountains,far from the countries Vokalia and
                                    Consonantia,there live the blind.</div>
                                <div class="btn-box"><a href="#" class="theme-btn btn-style-one bg-tealblue"><span
                ...
                <div class="row">
                    ...
                    <div class="content-column col-xl-6 col-lg-7 col-md-12 col-sm-12">
                        <div class="inner-column">
                            <div class="sec-title"><span class="sub-title">About Our Clinic</span>
                                <h2>Who We Are Pioneering in Health.</h2><span class="divider"></span>
                                <p>Where you are at the heart of our mission. We hope you will consider us as your
                                    medical home—the place where you feel safe,comfortable and cared for. As a
                                    multi-specialty medical group,</p>
                            </div>
                            <div class="row">
                                <!-- Feature BLock -->
                                <div class="feature-block-two col-lg-6 col-md-6 col-sm-12">
                                    <div class="inner-box"><span class="icon fa fa-stethoscope"></span>
                                ...
                                <div class="feature-block-two col-lg-6 col-md-6 col-sm-12">
                                    <div class="inner-box"><span class="icon fa fa-user-md"></span>
                ...
                <div class="row">
                    ...
                    <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="count-box">
                            ...
                            <h4 class="counter-title">Years of Experience</h4><span class="count-text" data-speed="3000"
                                data-stop="25">0</span>
                        </div>
                    </div>
                    <!--Column-->
                    <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                        <div class="count-box">
                            ...
                            <h4 class="counter-title">Medical Spesialities</h4><span class="count-text"
                    ...
                    <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
                        <div class="count-box">
                            ...
                            <h4 class="counter-title">Medical Spesialities</h4><span class="count-text"
                                data-speed="3000" data-stop="689">0</span>
                        </div>
                    </div>
                    <!--Column-->
                    <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="1200ms">
                        <div class="count-box">
                            ...
                            <h4 class="counter-title">Happy Patients</h4><span class="count-text" data-speed="3000"
                                data-stop="9036">0</span>
                        </div>
                    </div>
                </div>
            </div>
        </section><!-- Fun Fact Section Two -->
        <!-- Services Section -->
                        ...
                        <div class="service-block-two">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="title-box"><span class="icon flaticon-heart-2"></span>
                                    ...
                                    <div class="text">Introduction. Cardiology is the study heart conditions. The
                                        Consultant with whom you have an appointment is a specialist.</div><span
                                        class="icon-right flaticon-heart-2"></span>
                                </div>
                            </div>
                        </div><!-- service Block -->
                        <div class="service-block-two">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="title-box"><span class="icon flaticon-brain"></span>
                                        <h4><a href="department-detail.jsp">Neurology Department</a></h4>
                                    </div>
                                    <div class="text">It is the branch of medicine concerned with the study and
                                        treatment of disorders of the nervous system.</div><span
                                        class="icon-right flaticon-brain"></span>
                                </div>
                            </div>
                        </div><!-- service Block -->
                        <div class="service-block-two">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="title-box"><span class="icon flaticon-kidney"></span>
                                        <h4><a href="department-detail.jsp">Urology Department</a></h4>
                                    </div>
                                    <div class="text">It is the branch of medicine concerned with the study and
                                        treatment of disorders of the nervous system.</div><span
                                        class="icon-right flaticon-kidney"></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="portfolio-section">
            <div class="auto-container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="sec-title"><span class="sub-title">Modern Hospital Facilities</span>
                            <h2>Our Photo Gallery</h2><span class="divider"></span>
                        </div>
                    </div>
                </div>
                <!--MixitUp Galery-->
                <div class="mixitup-gallery">
                    <div class="btns-outer"><a href="gallery.jsp" class="theme-btn btn-style-one"><span
                                class="btn-title">View All</span></a>
                        <!--Filter-->
                    ...
                    <div class="filter-list row mid-spacing">
                        ...
                        <div class="portfolio-block all mix detal-care dental col-lg-4 col-md-6 col-sm-12">
                            <div class="image-box">
                                ...
                                <div class="overlay"><a href="images/gallery/1-1.jpg"
                                        class="icon-box lightbox-image"><span class="fa fa-expand"></span></a>
                                    <div class="title-box">
                                        <h5>Diagnostic Imagine</h5>
                                        <div class="cat"><a href="#">Orthopedics</a>,<a href="#">Pharmacy</a>,</div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- Portfolio Block -->
            ...
            <div class="auto-container">
                <div class="row">
                    ...
                    <div class="content-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column"><a href="https://www.youtube.com/watch?v=Fvae8nxzVz4" class="play-now"
                                data-fancybox="gallery" data-caption=""><i class="icon flaticon-play-button"
                                    aria-hidden="true"></i><span class="ripple"></span></a>
                            <div class="content"><span class="title">Need a Doctor for Check-up?</span>
                                <h3>Just Make an Appointment <br>and You’re Done!</h3>
                                <div class="text">Get Your Quote or Call:<strong>(0080) 123-453-789</strong></div><a
                                    href="#" class="theme-btn btn-style-three"><span class="btn-title">Get An
                                        Appointment</span></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="inner-column">
                            <div class="appointment-form default-form">
                                ...
                                <form action="#" method="post" id="email-form">
                                    ...
                                    <div class="form-group"><button class="theme-btn btn-style-one bg-tealblue"
        ...
        <section class="time-table-section pd-top-extra">
            <div class="auto-container">
                <!-- Sec Title -->
                <div class="sec-title text-center"><span class="title">Appointment Schedules</span>
                    <h2>Doctors Time Table</h2><span class="divider"></span>
                </div>
                            ...
                            <tr>
                                ...
                                <td><strong>Dental Care</strong>
                                    ...
                                    <div class="doctor-info">
                                        <figure class="thumb"><img src="images/resource/doctor-thumb.jpg" alt="">
                                        </figure>
                                        <h4 class="name">Dr. Tania Riham</h4><a href="#"
                                            class="theme-btn btn-style-one bg-tealblue"><span
                            ...
                            <div class="row">
                                ...
                                <div class="footer-column col-xl-7 col-lg-6 col-md-6 col-sm-12">
                                    <div class="footer-widget about-widget">
                                        <div class="logo"><a href="index.jsp"><img src="images/logo-5.png"
                                                                                   alt="" /></a></div>
                                        <div class="text">
