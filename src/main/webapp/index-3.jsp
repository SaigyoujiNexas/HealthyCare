...
<body>
    <div class="page-wrapper color-scheme-scarlet">
        <!-- Preloader -->
        ...
        <header class="main-header header-style-three">
            ...
            <div class="header-lower">
                <div class="auto-container">
                    ...
                    <div class="main-box">
                        <div class="logo-box">
                            <div class="logo"><a href="index.jsp"><img src="images/logo-6.png" alt="" title=""></a>
                            </div>
                        </div>
                        <!--Nav Box-->
                        <div class="nav-outer">
                                ...
                                <ul class="navigation" id="navbar">
                                    <li class="current dropdown"><span>Home</span>
                                        <ul>
                                            ...
                                            <li class="current"><a href="index-3.jsp">Home Dental Care</a></li>
            ...
            <div class="mobile-header">
                <div class="logo"><a href="index.jsp"><img src="images/logo-6.png" alt="" title=""></a></div>
                <!--Nav Box-->
        ...
        <section class="banner-section-two">
            <div class="banner-carousel owl-carousel owl-theme default-arrows dark">
                <!-- Slide Item -->
                <div class="slide-item" style="background-image: url(images/main-slider/3-1.jpg);">
                    <div class="auto-container">
                        <div class="content-outer">
                            <div class="content-box">
                                <div class="icon-box"><span class="icon flaticon-dental-insurance"></span></div>
                                <h1>Medicoz</h1>
                                <h3>Dental Center in Londan</h3>
                                <div class="text">Far far away,behind the word mountains,far from the countries Vokalia
                                    and Consonantia,there live the blind texts. </div>
                                <div class="btn-box"><a href="#" class="theme-btn btn-style-one bg-scarlet"><span
                                            class="btn-title">Take Service</span></a></div>
                            </div>
                        </div>
                    </div>
                </div><!-- Slide Item -->
                <div class="slide-item" style="background-image: url(images/main-slider/3-2.jpg);">
                    <div class="auto-container">
                        <div class="content-outer">
                            <div class="content-box">
                                <div class="icon-box"><span class="icon flaticon-dental-insurance"></span></div>
                ...
                <div class="row">
                    ...
                    <div class="content-column col-lg-5 col-md-12 col-sm-12 order-2">
                        <div class="inner-column">
                            <div class="sec-title"><span class="sub-title">How We Get to This Point</span>
                                <h2>Story About Our Hospital.</h2><span class="divider"></span>
                                <p>One of the first major discoveries relevant to the field of pulmonology was the
                                    discovery of pulmonary circulation. Originally,it was thought that blood reaching
                                    the right side of the heart passed through small ‘pores’ in the septum.</p>
                            </div>
                            <div class="about-owner"><img src="images/icons/sign.png" alt="" class="sign-img">
                    ...
                    <div class="blocks-column col-lg-12 order-3">
                        <div class="row">
                            ...
                            <div class="feature-block-three col-lg-4 col-md-6 col-sm-12">
                                <div class="inner-box"><span class="icon flaticon-dentist"></span>
                                    <h4>Best Dental Suargeons</h4>
                                    <p>Dentistry,also known as Dental and Oral Medicine,is a branch of medicine that
                                        consists.</p>
                                </div>
                            </div><!-- Feature BLock -->
                            <div class="feature-block-three col-lg-4 col-md-6 col-sm-12">
                                <div class="inner-box"><span class="icon flaticon-toothbrush"></span>
                            ...
                            <div class="feature-block-three col-lg-4 col-md-6 col-sm-12">
                                <div class="inner-box"><span class="icon flaticon-drilling"></span>
            ...
            <div class="auto-container">
                ...
                <div class="row">
                    ...
                    <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
                        <div class="count-box">
                            <div class="icon-box"><span class="icon flaticon-user-experience"></span></div><span
                                class="count-text" data-speed="3000" data-stop="25">0</span>
                    ...
                    <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                        <div class="count-box">
                            <div class="icon-box"><span class="icon flaticon-team"></span></div><span class="count-text"
                                data-speed="3000" data-stop="470">0</span>
                    ...
                    <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="800ms">
                        <div class="count-box">
                            <div class="icon-box"><span class="icon flaticon-hospital"></span></div><span
                                class="count-text" data-speed="3000" data-stop="689">0</span>
                            <h4 class="counter-title">Medical Spesialities</h4>
                        </div>
                    </div>
                    <!--Column-->
                    <div class="counter-column col-lg-3 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="1200ms">
                        <div class="count-box">
                            <div class="icon-box"><span class="icon flaticon-add-friend"></span></div><span
                                class="count-text" data-speed="3000" data-stop="9036">0</span>
        ...
        <section class="skill-section">
            <div class="outer-container clearfix">
                <div class="skill-column">
                    <div class="inner-column">
                        <div class="sec-title"><span class="sub-title">BEST OF THE BEST</span>
                            <h2>High End Equipments.</h2><span class="divider"></span>
                            <div class="text">Surgery of the respiratory tract is generally performed by specialists in
                                cardiothoracic surgery(or thoracic surgery) though minor procedures may be performed by
                                pulmonologists. Pulmonology is closely.</div>
                        </div>
                        <!--Skills-->
                        <div class="skills">
                            <!--Skill Item-->
                        ...
                        <div class="btn-box"><a href="#" class="theme-btn btn-style-three"><span class="btn-title">Learn
                                    More</span></a></div>
                    </div>
                </div>
        ...
        <section class="services-section-three">
            <div class="auto-container">
                <div class="sec-title text-center"><span class="sub-title">OUR SERVICES</span>
                    <h2>We Care Our Patients.</h2><span class="divider"></span>
                </div>
                <div class="row">
                    <!-- Service Block -->
                    <div class="service-block-three col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box"><span class="icon flaticon-dentist"></span>
                            ...
                            <div class="text">Dentistry,also known as dental medicine and ‘oral medicine,is a branch of
                                medicine that consists of the study,diagnosis,prevention,and treatment.</div><span
                                class="icon-float flaticon-dentist"></span>
                        </div>
                    </div><!-- Service Block -->
                    <div class="service-block-three col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box"><span class="icon flaticon-braces"></span>
                            <h5><a href="#">Orthodontics</a></h5>
                            <div class="text">Dentistry,also known as dental medicine and ‘oral medicine,is a branch of
                                medicine that consists of the study,diagnosis,prevention,and treatment.</div><span
                                class="icon-float flaticon-braces"></span>
                        </div>
                    </div><!-- Service Block -->
                    <div class="service-block-three col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box"><span class="icon flaticon-implant"></span>
                            <h5><a href="#">Dental Implants</a></h5>
                            <div class="text">Dentistry,also known as dental medicine and ‘oral medicine,is a branch of
                                medicine that consists of the study,diagnosis,prevention,and treatment.</div><span
                                class="icon-float flaticon-implant"></span>
                        </div>
                    </div><!-- Service Block -->
                    <div class="service-block-three col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box"><span class="icon flaticon-teeth"></span>
                            <h5><a href="#">Teeth Whitening</a></h5>
                            <div class="text">Dentistry,also known as dental medicine and ‘oral medicine,is a branch of
                                medicine that consists of the study,diagnosis,prevention,and treatment.</div><span
                                class="icon-float flaticon-teeth"></span>
                        </div>
                    </div><!-- Service Block -->
                    <div class="service-block-three col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box"><span class="icon flaticon-dental-insurance"></span>
                            <h5><a href="#">Cosmetic Dentistry</a></h5>
                            <div class="text">Dentistry,also known as dental medicine and ‘oral medicine,is a branch of
                                medicine that consists of the study,diagnosis,prevention,and treatment.</div><span
                                class="icon-float flaticon-dental-insurance"></span>
                        </div>
                    </div><!-- Service Block -->
                    <div class="service-block-three col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box"><span class="icon flaticon-tooth"></span>
                            <h5><a href="#">Gum Treatment</a></h5>
                            <div class="text">Dentistry,also known as dental medicine and ‘oral medicine,is a branch of
                                medicine that consists of the study,diagnosis,prevention,and treatment.</div><span
                                class="icon-float flaticon-tooth"></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="testimonial-section-two">
            <div class="auto-container">
                <!-- Sec Title -->
                <div class="sec-title text-center"><span class="title">HAPPY Patient</span>
                    <h2>What Says Our Patients</h2><span class="divider"></span>
                </div>
                    ...
                    <div class="client-thumb-outer">
                        <div class="client-thumbs-carousel owl-carousel owl-theme">
                            <div class="thumb-item">
                                ...
                                <div class="author-info"><span class="icon fa fa-quote-left"></span>
                ...
                <div class="call-to-action">
                    <div class="inner-container">
                        <div class="content-column">
                            ...
                            <h2>We Ensure Safe Dental Sergery </h2><a href="#" class="theme-btn btn-style-three"><span
                                    class="btn-title">Take Appointment</span></a>
                        </div>
                        <div class="video-column">
                            <div class="btn-box"><a href="https://www.youtube.com/watch?v=Fvae8nxzVz4" class="play-now"
                                    data-fancybox="gallery" data-caption=""><i class="icon flaticon-play-button"
                                        aria-hidden="true"></i><span class="ripple"></span></a><span class="title">Watch
                                    now</span></div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="footer-column col-xl-7 col-lg-6 col-md-6 col-sm-12">
                                    <div class="footer-widget about-widget">
                                        <div class="logo"><a href="index.jsp"><img src="images/logo-6.png"
                                                                                   alt="" /></a></div>
                                        <div class="text">
