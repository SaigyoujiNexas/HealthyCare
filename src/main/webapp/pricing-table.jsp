...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Pricing Table</title><!-- Stylesheets -->
...
<body>
    <div class="page-wrapper">
                                ...
                                <ul class="navigation" id="navbar">
                                    ...
                                    <li class="current dropdown"><span>Pages</span>
                                        <ul>
                                            ...
                                            <li class="current"><a href="pricing-table.jsp">Pricing Table</a></li>
        ...
        <section class="pricing-section">
            <div class="auto-container">
                <div class="tabs-box outer-box">
                    <!--Tabs Box-->
                    <ul class="tab-buttons clearfix">
                        <li class="tab-btn active-btn" data-tab="#tab1">Monthly</li>
                        <li class="tab-btn" data-tab="#tab2">Yearly</li>
                    </ul>
