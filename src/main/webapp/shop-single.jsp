...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Shop Single</title><!-- Stylesheets -->
                                ...
                                <ul class="navigation" id="navbar">
                                    ...
                                    <li class="dropdown current"><span>Shop</span>
                                        <ul>
                                            ...
                                            <li class="current"><a href="shop-single.jsp">Shop Single</a></li>
                                    ...
                                    <div class="row clearfix">
                                        <div class="image-column col-md-6 col-sm-12">
                                            <figure class="image-box"><a
                                                    ...
                                                    src="images/resource/products/product-sinlge.jpg" alt=""></a>
                                            </figure>
                                        </div>
                                        <div class="info-column col-md-6 col-sm-12">
                                            ...
                                            <div class="text">There are many variations of passages of Lorem Ipsum
                                                ...
                                                believable. If you are going.</div>
                                            <div class="other-options clearfix">
                                                <div class="item-quantity"><input class="quantity-spinner" type="text"
                                                        value="2" name="quantity"></div><button type="button"
                                                    class="theme-btn btn-style-one add-to-cart"><span
                                            ...
                                            <div class="tab" id="prod-details">
                                                <div class="content">
                                                    ...
                                                    <p>Excepteur sint occaecat cupidatat non proident,sunt in culpa qui
                                                        ...
                                                        consequat. sunt in culpa qui officia deserunt mollit</p>
                                                </div>
                                            </div>
                                            <!--Tab-->
                                            <div class="tab active-tab" id="prod-reviews">
                                                ...
                                                <div class="comments-area style-two">
                                                    ...
                                                    <div class="comment-box">
                                                        <div class="comment">
                                                            <div class="author-thumb"><img
                                                                    src="images/resource/avatar-1.jpg" alt=""></div>
                                                            <div class="comment-inner">
                                                                ...
                                                                <div class="text">Lorem Ipsum is simply dummy text of
                                                                    the printing and typesetting industry. Lorem Ipsum
                                                                    has been the industry.</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!--Comment Box-->
                                                    <div class="comment-box reply-comment">
                                                        <div class="comment">
                                                            <div class="author-thumb"><img
                                                                    src="images/resource/avatar-2.jpg" alt=""></div>
                                                            <div class="comment-inner">
                                                                <div class="comment-info">
                                                    ...
                                                    <div class="comment-box">
                                                        <div class="comment">
                                                            <div class="author-thumb"><img
                                                                    src="images/resource/avatar-3.jpg" alt=""></div>
                                                            <div class="comment-inner">
                                                                <div class="comment-info">
                                                                ...
                                                                <div class="text">Contrary to popular belief,Lorem Ipsum
                                                                    ...
                                                                    over 2000 years old. Richard McClintock,</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!-- Comment Form -->
                                                <div class="shop-comment-form">
                                                    <h2>Add a Review</h2>
                                                    <div class="mail-text"><span class="theme_color">Your email address
                                                            will not be published.</span>Required fields are marked*
                                                    </div>
                                                    <div class="rating-box">
                                                        <div class="text">Your Rating:</div>
                                                        <div class="rating"><a href="#"><span
                                                                    class="fa fa-star"></span></a></div>
                                                        <div class="rating"><a href="#"><span
                                                                    class="fa fa-star"></span><span
                                                                    class="fa fa-star"></span></a><a href="#"></a></div>
                                                        <div class="rating"><a href="#"><span
                                                                    class="fa fa-star"></span><span
                                                                    class="fa fa-star"></span><span
                                                                    class="fa fa-star"></span></a></div>
