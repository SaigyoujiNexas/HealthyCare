...
<head>
    <meta charset="utf-8">
    <title>Medicoz | Health and Medical HTML Template | Terms and Condition</title><!-- Stylesheets -->
...
<body>
    <div class="page-wrapper">
                                ...
                                <ul class="navigation" id="navbar">
                                    ...
                                    <li class="current dropdown"><span>Pages</span>
                                        <ul>
                                            ...
                                            <li class="current"><a href="terms-and-condition.jsp">Terms and
                                                    Condition</a></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="row">
                        <div class="column col-xl-3 col-lg-4 col-md-12 col-sm-12">
                            ...
                            <ul class="tab-buttons">
                                ...
                                <li data-tab="#tab-b" class="tab-btn">Our Terms</li>
                                <li data-tab="#tab-c" class="tab-btn">Conditions</li>
                                <li data-tab="#tab-d" class="tab-btn active-btn">Your Privacy</li>
                                <li data-tab="#tab-e" class="tab-btn">Informations We Collect</li>
                        ...
                        <div class="column col-xl-9 col-lg-8 col-md-12 col-sm-12">
                            ...
                            <div class="tabs-content">
                                ...
                                <div class="tab" id="tab-a">
                                    <h4>Welcome Text</h4>
                                    <p>Searcys St Pancras' adored Champagne bar is famously the longest in Europe. Here,
                                        guests can enjoy panoramic views of the magnificent station. For those looking
                                        to enjoy a glass of something special, the menu showcases a variety of Champagne
                                    ...
                                    <h5>Our Terms</h5>
                                    <p>Searcys St Pancras' adored Champagne bar is famously the longest in Europe.
                                        Here,guests can enjoy panoramic views of the magnificent station. For those
                                        looking to enjoy a glass of something special,the menu showcases a variety of
                                        Champagne and sparkling wines from around the world,including nine options by
                                        the glass.</p>
                                    <p>Lorem ipsum dolor sit amet,consectetur adipiscing elit. Maecenas in pulvinar
                                        neque. Nulla finibus lobortis pulvinar. Donec a consectetur nulla. Nulla posuere
                                        sapien vitae lectus suscipit,et pulvinar nisi tincidunt. Aliquam erat volutpat.
                                ...
                                <!--Tab-->
                                <div class="tab active-tab" id="tab-d">
                                    <h4>Your Privacy</h4>
                                    <p>Searcys St Pancras' adored Champagne bar is famously the longest in Europe. Here,
                                        guests can enjoy panoramic views of the magnificent station. For those looking
                                        to enjoy a glass of something special, the menu showcases a variety of Champagne
        ...
        </section><!-- End Terms And Conditions -->
        <!-- Main Footer -->
